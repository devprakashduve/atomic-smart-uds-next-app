                ...
                <div className="sm:col-span-8 lg:col-span-7">
                  ...
                  <section aria-labelledby="options-heading" className="mt-10">
                    ...
                    <form>
                          ...
                          {product.sizes.map((size) => (
                            <Radio
                              ...
                              className={classNames(
                                ...
                                'focus:outline-hidden data-focus:ring-2 data-focus:ring-indigo-500 group relative flex items-center justify-center rounded-md border px-4 py-3 text-sm font-medium uppercase hover:bg-gray-50 sm:flex-1'
                              )}
                            >
                              <span>{size.name}</span>
                              {size.inStock ? (
                      ...
                      <button
                        type="submit"
                        className="focus:outline-hidden mt-6 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                      >
                        Add to bag
                      </button>
                    </form>
